...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterResponse, succes_),
};
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "bug.ResultCode\022\016\n\006succes\030\002 \001(\0102\205\001\n\016UserS"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_2eproto = {
  &descriptor_table_user_2eproto_initialized, descriptor_table_protodef_user_2eproto, "user.proto", 459,
...
void RegisterResponse::SharedCtor() {
  ...
  ::memset(&result_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&succes_) -
      reinterpret_cast<char*>(&result_)) + sizeof(succes_));
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          succes_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* RegisterResponse::_InternalSerialize(
  ...
  if (this->succes() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(2, this->_internal_succes(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.RegisterResponse)
  ...
  if (from.succes() != 0) {
    _internal_set_succes(from._internal_succes());
  }
}
