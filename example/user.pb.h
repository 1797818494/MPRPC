...
// bool succes = 2;
inline void RegisterResponse::clear_succes() {
  succes_ = false;
}
inline bool RegisterResponse::_internal_succes() const {
  return succes_;
}
inline bool RegisterResponse::succes() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.succes)
  return _internal_succes();
}
inline void RegisterResponse::_internal_set_succes(bool value) {
  
  succes_ = value;
}
inline void RegisterResponse::set_succes(bool value) {
  _internal_set_succes(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterResponse.succes)
}
